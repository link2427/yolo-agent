# yolo-dev:5.0 — Documentation Bundle

Complete operator documentation for the `yolo-dev:5.0` container image
(locked-down local coding agents, browser IDE, Gitea push support).
