...
| prime-agent | 0.7.1 | Prime Intellect agent; IPython kernel pre-bootstrapped; telemetry off |
| code-server | 4.117.0 | VS Code in the browser (:8080) + 15-extension pack |
| ttyd | 1.7.7 | Browser terminal (:7681), tmux-backed |
| Skills library | 924 skills | 10 curated repos, MIT/Apache-2.0, pinned + hash-verified |
