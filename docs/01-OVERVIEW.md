...
| --- | --- | --- |
| Full | Five agents, code-server, ttyd/tmux, complete skills library | Persistent browser development box |
| Headless | Five agents and core developer tools | CI, terminals, and smaller transfers |
